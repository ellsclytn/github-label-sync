...
export type GetAllLabelsQueryVariables = Exact<{
  reposAfter: Maybe<Scalars['String']>;
  org: Scalars['String'];
}>;


export type GetAllLabelsQuery = (
  { readonly __typename?: 'Query' }
